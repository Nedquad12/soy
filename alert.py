...
class StockVolumeMonitor:
    def __init__(self, bot_token: str, admin_ids: List[int] = None):
        ...
        self.popular_stocks = [
                             'BBCA.JK', 'BBRI.JK', 'BMRI.JK', 'ADRO.JK', 'TLKM.JK', 'ASII.JK', 'ANTM.JK', 'UNVR.JK',
                             'INDF.JK', 'ICBP.JK', 'PGAS.JK', 'PTBA.JK', 'BBNI.JK', 'KLBF.JK', 'ITMG.JK', 'UNTR.JK', 
                             'JPFA.JK', 'GOTO.JK', 'BRIS.JK', 'CTRA.JK', 'SMGR.JK', 'JSMR.JK', 'CPIN.JK', 'SIDO.JK',
                             'SMRA.JK', 'BRPT.JK', 'BBTN.JK', 'INCO.JK', 'MEDC.JK', 'ACES.JK', 'MDKA.JK', 'EXCL.JK',
                             'INKP.JK', 'ARTO.JK', 'ADMR.JK', 'PGEO.JK', 'AKRA.JK', 'AMRT.JK', 'ISAT.JK', 'TOWR.JK',
                             'AMMN.JK', 'ESSA.JK', 'MAPI.JK', 'MBMA.JK', 'MAPA.JK', 'GGRM.JK', 'MYOR.JK', 'MNCN.JK',
                             'BSDE.JK', 'PWON.JK', 'INTP.JK', 'HRUM.JK', 'SCMA.JK', 'LSIP.JK', 'BRMS.JK', 'ELSA.JK',
                             'PANI.JK', 'ELSA.JK', 'INDY.JK', 'BNGA.JK', 'ERAA.JK', 'TKIM.JK', 'BTPS.JK', 'EMTK.JK',
                             'ENRG.JK', 'GJTL.JK', 'BUKA.JK', 'SRTG.JK', 'AUTO.JK', 'NISP.JK', 'PNLF.JK', 'MIKA.JK',
                             'TAPG.JK', 'NCKL.JK', 'BFIN.JK', 'MTEL.JK', 'AVIA.JK', 'SSIA.JK', 'DSNG.JK', 'HEAL.JK',
                             'CMRY.JK'
                               ]
